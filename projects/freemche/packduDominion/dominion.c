...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return cardAdventurer(currentPlayer, temphand, z, state, drawntreasure, cardDrawn);
    ...
    case feast:
      return cardFeast(currentPlayer, state, temphand, choice1);
			
    case gardens:
      return -1;
			
    case mine:
      return cardMine(currentPlayer, state, handPos, choice1, choice2);
    ...
    case baron:
      return cardBaron(currentPlayer, state, choice1);
...
int cardAdventurer (int currentPlayer, int temphand[], int z, struct gameState *state, int drawntreasure, int cardDrawn) {
...
int cardFeast (int currentPlayer, struct gameState *state, int temphand[], int choice1) {
...
int cardBaron (int currentPlayer, struct gameState *state, int choice1) {
